...
GspinoBasis="At:dyall_aae2z,Cl:dyall_aae2z,H:dyall_aae2z,N:dyall_aae2z"
fittingbasis="At:b20,Cl:dgauss-a2-dftjfit,H:dgauss-a2-dftjfit,N:dgauss-a2-dftjfit"
...
python3 $BASEDIR/berthaingen/pybgen/pybgen.py -f ../$frag1xyz  -b $GspinoBasis -t $fittingbasis --convertlengthunit 1.8897259886 --functxc $excfunct -j $basisset --totalcharge 0 
...
mkdir $NOCVDIR 
cd $NOCVDIR
python3 $BASEDIR/berthaingen/pybgen/pybgen.py -f ../$moleculexyz -b $GspinoBasis -t $fittingbasis --convertlengthunit 1.8897259886 --functxc $excfunct -j $basisset  --totalcharge 0 

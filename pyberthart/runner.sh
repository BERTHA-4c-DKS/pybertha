...
python /home/redo/BERTHA/Exanalysis/misc/pade/pade_transform.py --limit 6250 --gamma 1.0e-3 -f dipole.txt --dw 0.002 --fmin 1.5 --frequency 7.5 -o zz_w.txt > pade.txt

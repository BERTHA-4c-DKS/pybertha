...
export PYBERTHA_MOD_PATH="/home/belp/EMBEDDING/pybertha/pyemb;/home/belp/EMBEDDING/xcfun/build/lib64/python;/home/belp/EMBEDDING/pybertha/src;/home/belp/EMBEDDING/pyadf/src;/home/belp/EMBEDDING/berthaingen/pybgen;/home/belp/EMBEDDING/pybertha/psi4rt"

export LD_LIBRARY_PATH=$LD_LIBRARY_PATH:/home/belp/EMBEDDING/pybertha/lib

export outputfile=risudyallDZ_B16_thread32
...
python3 pyberthaembed_timing.py -gA au2.xyz -gB w8.xyz --act_fittset "Au:b16" --act_obs "Au:dyall_vdz" --convertlengthunit=1.8897259886 --act_func LDA --env_obs DZ --wrapperso /home/belp/EMBEDDING/pybertha/lib/bertha_wrapper.so -v 1  > $outputfile 2>&1
